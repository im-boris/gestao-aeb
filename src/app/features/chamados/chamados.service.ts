...
export class ChamadosService {
    ...
    statusChamado: StatusChamado[] = [
        ...
        {id: 2, descricao: Status.SUSPENSO.toLocaleLowerCase()},
    ];
    ...
    chamados: Chamado[] = [
        ...
        {id: 25881, status:{id:3, descricao: Status.SUSPENSO}, dataAbertura: new Date("2023-01-20"), dataAtendimento: new Date("2023-06-21"), dataSuspensao: new Date("2024-01-19")},
        ...
        {id: 51104, status:{id:2, descricao: Status.ABERTO}, dataAbertura: new Date("2023-03-11"), dataAtendimento: new Date("2023-09-22"), dataSuspensao: new Date("2024-01-20")},
        ...
        {id: 74781, status:{id:2, descricao: Status.SUSPENSO}, dataAbertura: new Date("2023-02-08"), dataAtendimento: new Date("2023-08-23"), dataSuspensao: new Date("2023-12-20")},
